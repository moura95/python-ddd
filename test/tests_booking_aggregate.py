...
from domain.driver.exception import *
from domain.vehicle.exception import *
from domain.vehicle.entity import Customer
...
class BookingAggregateTests(unittest.TestCase):
    ...
    def test_checkin_date_cannot_be_after_checkout_date(self):
        ...
        booking = Driver(checkin=checkin, checkout=checkout, customer=customer)
    ...
    def test_customer_cannot_be_blank(self):
        ...
        booking = Driver(checkin=checkin, checkout=checkout, customer=None)
