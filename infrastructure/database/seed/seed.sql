...
INSERT INTO drivers_vehicles (driver_id, vehicle_id)
VALUES
    ((SELECT uuid FROM drivers WHERE email = 'motorista1@example.com'), (SELECT id FROM vehicles WHERE license_plate = 'ABC123')),
    ((SELECT uuid FROM drivers WHERE email = 'motorista2@example.com'), (SELECT id FROM vehicles WHERE license_plate = 'XYZ987')),
    ((SELECT uuid FROM drivers WHERE email = 'motorista3@example.com'), (SELECT id FROM vehicles WHERE license_plate = 'DEF456')),
    ((SELECT uuid FROM drivers WHERE email = 'motorista4@example.com'), (SELECT id FROM vehicles WHERE license_plate = 'GHI789')),
    ((SELECT uuid FROM drivers WHERE email = 'motorista5@example.com'), (SELECT id FROM vehicles WHERE license_plate = 'JKL321'));
